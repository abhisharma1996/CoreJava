...
public class AssociateDAOImpl implements AssociateDAO {
	...
	public Associate findOne(int associateId) throws SQLException {
		...
		if(associateRS.next()) {
			...
			salaryRS.next();
			associate.setSalary(new Salary(salaryRS.getInt("basicSalary"), salaryRS.getInt("hra"), salaryRS.getInt("conveyenceAllowance"), salaryRS.getInt("otherAllowance"), salaryRS.getInt("personalAllowance"), salaryRS.getInt("monthlyTax"), salaryRS.getInt("epf"), salaryRS.getInt("companyPf"), salaryRS.getInt("grossSalary"), salaryRS.getInt("netSalary"), accountNumber));
	...
	public ArrayList<Associate> findAll() throws SQLException  {
		...
		while(associateRS.next()) {
			...
			ResultSet salaryRS =pstmt3.executeQuery();
			salaryRS.next();
			associate.setSalary(new Salary(salaryRS.getInt("basicSalary"), salaryRS.getInt("hra"), salaryRS.getInt("conveyenceAllowance"), salaryRS.getInt("otherAllowance"), salaryRS.getInt("personalAllowance"), salaryRS.getInt("monthlyTax"), salaryRS.getInt("epf"), salaryRS.getInt("companyPf"), salaryRS.getInt("grossSalary"), salaryRS.getInt("netSalary"), salaryRS.getInt("accountNumber")));
